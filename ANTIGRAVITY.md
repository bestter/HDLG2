...
* Les tests UI WinForms (`WinFormsUiTests`) s'exécutent sur thread **STA** et vérifient la structure des contrôles UI modernes (`ModernCardPanel`, `ModernButton`) sans interaction graphique utilisateur.
